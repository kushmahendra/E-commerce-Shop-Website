  ...
  return (
    <>
      ...
      <header className='fixed top-0 left-0 w-full z-50  w-nav'>
        <nav className='max-w-full bg-white  flex justify-even items-center py-4'>
   
        <button className="lg:hidden text-gray-700" onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}>
          <i className="ri-menu-line text-sm sm:text-md md:text-lg  "></i>
        </button>
      

          <ul className="flex flex-1 bg-text-blue-700  items-center  list-none  xl:space-x-8 lg:space-x-6   hidden lg:flex     ">
          ...
          <div className='pl-24 sm:pl-60 md:pl-72 xl:pl-36  text-lg sm:text-xl md:text-xl lg:text-2xl xl:text-2xl font-extrabold font-header text-textDark'>
            <Link to='/'>
          ...
          <div className='flex flex-1 items-center justify-end gap-4 sm:gap-4 md:gap-6 lg:gap-7 xl:gap-8 relative'>
            <span>
              <Link to='/search'>
            ...
            <span>
              <button onClick={handleCartToggle} className='hover:text-primary'>
                ...
                <sup className='text-xs sm:text-sm md:text-sm lg:text-sm xl:text-md inline-block px-1 sm:px-1.5 md:px-1.5 lg:px-1.5  text-white rounded-full bg-primary text-center'>{items?.length || 0}</sup>
              </button>
            </span>
            ...
            <div className="relative" >
              {user && user ? (<>
                {/* <img onClick={handleDropDownToggle}
                  ...
                  src={user?.profileImage || (<Link to='/login'>
...
{user?.profileImage ? (
  ...
  <Link to='/login'>
    <i className="ri-user-line text-lg sm:text-lg md:text-lg lg:text-xl xl:text-xl          cursor-pointer"></i>
  </Link>
)}
        ...
        {isMobileMenuOpen && (
          <div className="fixed top-0 left-0 w-20 h-1/6 bg-pink-50 shadow-lg p-2 z-50">
            <button
            ...
            <ul className="mt-2 space-y-2 text-xs sm:text-xs md:text-sm  ">
              <li><Link to="/"  onClick={() => setIsMobileMenuOpen(false)} className="block  hover:text-orange-700">Home</Link></li>
              <li><Link to="/shop"  onClick={() => setIsMobileMenuOpen(false)} className="block  hover:text-orange-700">Products</Link></li>
              <li className="relative group" >
              <button
                className="flex items-center space-x-2 hover:text-orange-700 cursor-pointer"
                onClick={() => setIsPagesDropDownOpen(!isPagesDropDownOpen)}
              >
                Pages
                <svg
              ...
              <li><Link to="/about-us"  onClick={() => setIsMobileMenuOpen(false)} className="block hover:text-orange-700">About Us</Link></li>
            </ul>
          </div>
        )}
